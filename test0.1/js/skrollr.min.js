...
(function(e, t, n) {
    ...
    var r = e.skrollr = {
        ...
        VERSION: "0.5.11"
    }, i = Object.prototype.hasOwnProperty, s, o, u = "rendered", a = "un" + u, f = "skrollable", l = "skrollr", c = "no-" + l, h = "linear", p = 1e3, d = 200, v = "start", m = "end", g = "top", y = "center", b = "bottom", w = "___has_rendered_class", E = "___skrollable_id", S = e.requestAnimationFrame;
    (function() {
    ...
    var F = function() {
        ...
        for (s = 0; s < tt.length; s++) {
            ...
            for (o = 0; o < r.length; o++)
                i = r[o], i.mode === "relative" && (u = t.style.cssText, a = J(t), t.style.cssText = e.styleAttr, K(t, e.classAttr), i.frame = et.relativeToAbsolute(n, i.anchors[0], i.anchors[1]) - i.offset, t.style.cssText = u, K(t, a)), rt&&!i.isEnd && i.frame > it && (it = i.frame)
        }
        for (s = 0; s < tt.length; s++) {
            e = tt[s], r = e.keyFrames;
            for (o = 0; o < r.length; o++)
                i = r[o], i.isEnd && (i.frame = it - i.offset)
        }
    }, I = function(e, t) {
        for (var n = 0; n < tt.length; n++) {
            ...
            if (h || p) {
                ...
                for (d in m)
                    i.call(m, d) && (v = V(m[d].value), r.setStyle(s.element, d, v));
        ...
        if (ct)
            r >= ct.endTime ? (e = ct.targetTop, t = ct.done, ct = n) : (i = ct.easing((r - ct.startTime) / ct.duration), e = ct.startTop + i * ct.topDiff | 0), et.setScrollTop(e);
        else {
        ...
        for (var t = 0; t < e.keyFrames.length; t++) {
            ...
            while ((u = N.exec(n.props)) !== null)
                s = u[1], i = u[2], r = s.match(C), r !== null ? (s = r[1], r = r[2]) : r = h, i = i.indexOf("!") ? U(i) : [i.slice(1)], o[s] = {
                    value: i,
                    easing: B[r]
                };
            n.props = o
